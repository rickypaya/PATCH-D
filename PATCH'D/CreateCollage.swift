...
struct CreateCollageView: View {
    ...
    private let predefinedThemes = [
        "Sunset Vibes 🌅","Coffee Shop Moments ☕","Fit Check 👟","Food Tour 🍕",
        "Night Out 🌃","Beach Day 🏖️","Concert & Festival 🎵","Pet Time 🐾",
        "Travel Adventures ✈️","Gym & Wellness 💪","Brunch Squad 🥞","Road Trip 🚗",
        "Nature Escape 🌿","Thrift Finds 🛍️","Game Night 🎮"
    ]
